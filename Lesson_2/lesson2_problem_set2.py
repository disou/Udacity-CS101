...
def fix_machine(debris, product):
    return product if ''.join([letter for letter in product if
                               letter in debris]) == product \
        else "Give me something that's not useless next time."


### TEST CASES ###
print "Test case 1: ", "Give me something that's not useless next time." == fix_machine(
    'UdaciousUdacitee', 'Udacity')
